...
@extends('layouts.app')
@section('title', 'Actualités du Circuit')
@section('content')

  <section>
    <div class="info-row">
    <img src="{{ asset('assest/images/actu1.jpg') }}" alt="Image info 1" class="info-image" />
  ...
  <div class="info-row">
    <img src="{{ asset('assest/images/actu2.jpg') }}" alt="Image info 2" class="info-image" />
    <div class="info-content">
      <div class="title-box">
  ...
  <div class="info-row">
    <img src="{{ asset('assest/images/actu3.jpg') }}" alt="Image info 3" class="info-image" />
    <div class="info-content">
      <div class="title-box">
  ...
  <div class="info-row">
    <img src="{{ asset('assest/images/photo du pasteur.png') }}" alt="Image info 4" class="info-image" />
    <div class="info-content">
      <div class="title-box">
  ...
  <div class="info-row">
    <img src="{{ asset('assest/images/bishop Séraphin Moudé.jpg') }}" alt="Image info 5" class="info-image" />
    <div class="info-content">
      <div class="title-box">
  ...
  <div class="info-row">
    <img src="{{ asset('assest/images/fidèlede temple.jpeg') }}" alt="Image info 6" class="info-image" />
    <div class="info-content">
      <div class="title-box">
